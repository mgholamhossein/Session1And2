...
item_purchase_currency = 'ZWL'
price = (usd_exchange_rates.get(item_purchase_currency, 'none') * item_original_price)

print("Item name", item_name)
print("Original price", "$", item_original_price, "(", item_original_currency, ")")
print("Purchased price", "$ %.2f" % price, "(", item_purchase_currency, ")")
